  ...
  function NodeView({
    ...
    return jsxRuntime.jsxs("div", {
      ...
      children: [jsxRuntime.jsx("div", {
        ...
        children: node.type
      }), (_a = node.children) === null || _a === void 0 ? void 0 : _a.map(c => jsxRuntime.jsx(NodeView, {
        node: c
      }, c.id))]
    });
  }
...
const Inspector = ({
  ...
  return jsxRuntime.jsxs("div", {
    ...
    }), entries.map(([k, v]) => jsxRuntime.jsxs("label", {
      style: {
        display: 'grid',
        gap: 4
      },
  ...
  return jsxRuntime.jsxs("div", {
    ...
    children: [jsxRuntime.jsxs("div", {
      ...
      children: [jsxRuntime.jsx("div", {
        ...
        children: "Palette"
      }), jsxRuntime.jsx(Palette, {
        onInsert: add,
        factories: factories
      }), chatAdapter !== null && jsxRuntime.jsxs("div", {
        style: {
          display: 'grid',
          gap: 8
        },
